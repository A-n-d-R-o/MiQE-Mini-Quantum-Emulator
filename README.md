...
To use, place MiQE.py file into the same directory as the file you are importing to, ensuring you have the required packages installed on your system, and then simply run:
```python
from MiQE import *
```
